...
********************************************/
		if (bank==0)
			strcpy(p, DropBlanks(text));
		else
			PutString(DropBlanks(text), p);
...
***************************************************************/
		if (lp_arr_i_bank[line]==0)
			strcpy(tmpbuf, ExpandTabs(lp_arr[line]) + pos);
		else
		{
			GetString(mybuf, lp_arr[line]);
			strcpy(tmpbuf, mybuf + pos);  
		}
...
*************************************************/
			if (bank==0)
				strcpy(p, DropBlanks(p2));
			else
				PutString(DropBlanks(p2), p);
...
******************************************************/
			if (bank==0)
				strcpy(p, DropBlanks(tmpbuf));
			else
				PutString(DropBlanks(tmpbuf), p);
