...
******************************************************/
        if (lp_arr_i_bank[lp_cur]==0)
                Xstrcpy(ln_dat, lp_arr[lp_cur]);
        else
                XGetString(ln_dat, lp_arr[lp_cur]);
...
*******************************************************************/
                if (lp_arr_i_bank[lp_cur]==0)
                        Xstrcpy(tmpbuf, lp_arr[lp_cur]);
                else
                        XGetString(tmpbuf, lp_arr[lp_cur]);
                ...
                if (memcmp(tmpbuf, ln_dat, len))
                {
                        ...
                        if (lp_arr_i_bank[lp_cur]==0)
                                strcpy(lp_arr[lp_cur], DropBlanks(ln_dat));
                        else
                                PutString(DropBlanks(ln_dat), lp_arr[lp_cur]);
