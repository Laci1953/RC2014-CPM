...
#asm
	psect	data
_cf_rows:      defb 48               ;  1 byte  > Screen rows or 0 for auto.
_cf_cols:      defb 64               ;  1 byte  > Screen columns or 0 for auto.
#endasm
...
#asm
	psect	data
_cf_rows:      defb 24               ;  1 byte  > Screen rows or 0 for auto.
...
_cf_mx_lines:  defw 0               ;  2 bytes > Max. number of lines in editor.
                                    ;            Each line takes 2 bytes (1 word) of memory.

_cf_tab_cols:  defb 8                ;  1 byte  > How many spaces a tabulation inserts.
...
_cf_clang:     defb 0                ;  1 byte  > C language auto completion: [], {}, (), "", '', /**/.

_cf_indent:    defb 0                ;  1 byte  > Automatic indent according to the indent of previous line.

_cf_list:      defb 0                ;  1 byte  > Automatic list.
_cf_list_chr:  defm '-*>'
