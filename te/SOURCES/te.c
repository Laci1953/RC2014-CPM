...
int main(int argc, char** argv)
{
        ...
        {
                /* display help */
                sprintf(ln_dat, "TE text editor\r\n");
                putstr(ln_dat);
                sprintf(ln_dat, "Copyright (c) 2015-2021 Miguel Garcia / FloppySoftware\r\n");
                putstr(ln_dat);
#ifdef  M128
                sprintf(ln_dat, "Adapted for 2x64KB RAM by Ladislau Szilagyi\r\n");
                putstr(ln_dat);
#endif
#ifdef  M512
                sprintf(ln_dat, "Adapted for 512KB RAM by Ladislau Szilagyi\r\n");
                putstr(ln_dat);
#endif
#ifdef  Z80ALL
                sprintf(ln_dat, "Adapted for 4x32KB RAM by Ladislau Szilagyi\r\n");
                putstr(ln_dat);
#endif
                ...
                putstr(ln_dat);
                sprintf(ln_dat, " -Tn (n = 4 or 8) sets the tabs to n spaces, default is 8\r\n");
                putstr(ln_dat);
#ifdef Z80ALL
                sprintf(ln_dat, " -Hnn sets the screen height (up to 48, default is 48)\r\n");
                putstr(ln_dat);
                sprintf(ln_dat, " -Wnnn sets the screen width (up to 64, default is 64)\r\n");
                putstr(ln_dat);
#else
                sprintf(ln_dat, " -Hnn sets the screen height (up to 99, default is 24)\r\n");
                putstr(ln_dat);
                sprintf(ln_dat, " -Wnnn sets the screen width (up to 200, default is 80)\r\n");
                putstr(ln_dat);
#endif
