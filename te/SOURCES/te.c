...
#ifdef 	M128
		printf("Adapted for 2x64KB RAM by Ladislau Szilagyi\r\n");
#endif
#ifdef	M512
		printf("Adapted for 512KB RAM by Ladislau Szilagyi\r\n");
#endif
#ifdef 	Z80ALL
		printf("Adapted for 4x32KB RAM by Ladislau Szilagyi\r\n");
#endif
		printf("\r\nUse: >TE [options] [filename]\r\n");
		printf("\r\nwhere options (lowercase or uppercase) are:\r\n");
		printf(" -Tn (n = 4 or 8) sets the tabs to n spaces, default is 8\r\n");
#ifdef Z80ALL
		printf(" -Hnn sets the screen height (up to 48, default is 48)\r\n");
		printf(" -Wnnn sets the screen width (up to 64, default is 64)\r\n");
#else
