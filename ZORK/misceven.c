...
void BoatGoToRoutine(int newroom)
{
  ...
  if ((Room[newroom].prop & R_BODYOFWATER) == 0)
    PrintCompLine("\x85\x6d\x61\x67\x69\x63\xb0\x6f\xaf\xb3\xe1\xbe\x89"
"\xd0\xa9\xc5\xae\xb4\x81\x73\x68\xd3\x65\x2e\x0a");
  ...
  if (IsPlayerInDarkness())
  {
    if (prev_darkness)
    {
      ...
      PrintCompLine("\x0a\x0a\x0a\x0a\x0a\x4f\x68\xb5\xe3\x21\x88\xc0"
"\x61\xd7\xb7\xe2\x6b\xd5\xa8\xe5\xba\x81\x73\xfd\xd7\xf1\x9c\x66\xad"
"\x67\xa1\xdd\xa3\xcb\xd8\x6b\x84\x67\x72\x75\x65\x21");
      YoureDead(); /* ##### RIP #####*/
      return;
    }
    else PrintCompLine("\x8b\xcd\xd7\xee\x6f\xd7\xab\xa7\xbd\xa3\xcc"
"\xbb\x6b\xeb\xfd\x63\x65\x2e");
  }
