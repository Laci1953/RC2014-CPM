...
int object_position[OPEN_PANEL + 1];  
int lamp_counter = 0;                 
bool lamp_is_on = false;              
bool mouse_is_fed = false;            
bool wizard_is_dead = false;         
int wizard_counter = 0;              
int vault_status = STATUS_LOCKED; 
bool river_is_open = false;         
bool chasm_is_bridged = false;       
int drawer_status = STATUS_LOCKED; 
int chest_status = STATUS_LOCKED;  
int darkness_counter = 0;             
int river_counter = 0;                
bool chased_by_gnome = false;         
bool heard_voiceover = false;         
bool lamp_has_dimmed = false;        
bool better_hurry = false;          
int hint_penalties = 0;             
int turn_counter = 0;                
int death_counter = 0;              
