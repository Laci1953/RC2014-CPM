...
extern int object_position[OPEN_PANEL + 1]; 
extern int lamp_counter;                 
extern bool lamp_is_on;              
extern bool mouse_is_fed;            
extern bool wizard_is_dead;
extern int wizard_counter;
extern int vault_status;
extern bool river_is_open; 
extern bool chasm_is_bridged; 
extern int drawer_status; 
extern int chest_status; 
extern int darkness_counter; 
extern int river_counter;   
extern bool chased_by_gnome; 
extern bool heard_voiceover;  
extern bool lamp_has_dimmed;  
extern bool better_hurry;    
extern int hint_penalties;  
extern int turn_counter;   
extern int death_counter;    
