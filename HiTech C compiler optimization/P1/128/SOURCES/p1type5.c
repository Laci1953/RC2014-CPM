...
void tmp_69ca(uint8_t p1, s8_t *p2, uint8_t p3, s8_t *var1b, sym_t *p4, bool v)
{
    sym_t* nextSym;
    int i4;
	...
	if (v)
        ...
        prError(100+7, /* p12_a297->p8->i_nextSym->nVName */
		GetWord((char*)nextSym+OFF_nVName));
    }
	...
	if (byte_a299 == D_6 && p1 != D_MEMBER) 
	{
            if (GetWord((char*)(p12_a297->p25)+OFF_m18) & 8)
                prError(100+5, GetWord((char*)(p12_a297->p25)+OFF_nVName));
            else if (!(GetWord((char*)(p12_a297->p25)+OFF_m18) & 0x20))
                prError(100+6, GetWord((char*)(p12_a297->p25)+OFF_nVName));
            else 
	    {
