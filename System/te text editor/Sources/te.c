...
#ifdef	M64
                putstr("Adapted for 64KB RAM RC2014 by Ladislau Szilagyi\r\n");
#else
#ifdef  M128
                putstr("Adapted for 2x64KB RAM RC2014 by Ladislau Szilagyi\r\n");
#endif
#ifdef  M512
                putstr("Adapted for 512KB RAM RC2014 by Ladislau Szilagyi\r\n");
#endif
#ifdef  Z80ALL
                putstr("Adapted for 4x32KB RAM by Ladislau Szilagyi\r\n");
#endif
#endif
...
#ifdef Z80ALL
                putstr(" -Hnn sets the screen height (up to 48, default is 48)\r\n");
                putstr(" -Wnnn sets the screen width (up to 64, default is 64)\r\n");
#else
