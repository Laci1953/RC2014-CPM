...
#else
	sprintf(tmpbuf, "%u bytes available memory", freeMem);
#endif
...
#ifdef M128
#ifdef SC108
	CenterText(row++, "Adapted for SC108");	
#endif //SC108
#ifdef MM
	CenterText(row++, "Adapted for 32KB ROM + 128KB RAM memory module");
#endif //MM
#ifdef SC114
	CenterText(row++, "Adapted for SC114");
#endif //SC114
#ifdef S80
...
#ifdef M512
	CenterText(row++, "Adapted for 512KB RAM module");
#endif
#ifdef Z80ALL
